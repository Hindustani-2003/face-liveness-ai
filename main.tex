...
\centering \textbf{Sh. Pankaj Roy} \\[0.15cm]
\centering \textbf{Assistant Manager (IT)} \\[0.15cm]
\centering \textbf{National Capital Region Transport Corporation , New Delhi} \\[0.2cm]
\hline
\end{tabular}
\end{flushright}
